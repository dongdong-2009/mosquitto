...
#include "../data_type.h"			//add by mkk 2016-12-01 为整体工程提供mqtt数据过滤接口
 ...
 * Main functions
 * ============================================================ */
int mosquitto_main_loop(struct mosquitto_db *db, mosq_sock_t *listensock, int listensock_count, int listener_max,Data_filter *);
...
int mqtt3_db_message_write(struct mosquitto_db *db, struct mosquitto *context,Data_filter*);
